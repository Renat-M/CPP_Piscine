...
/*   Updated: 2022/05/23 21:40:29 by meourea          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    try
	{
        try
		{
            Form *f = intern.makeForm("ABOBA", "OBABO");
        ...
        form[0] = intern.makeForm("shrubbery creation", "Garden");
        form[1] = intern.makeForm("robotomy request", "Fridge");
        form[2] = intern.makeForm("presidential pardon", "Zel");
